...
import { initTerrainSampler } from "./ocean/oceanUtils/terrainSampler";
...
export default function Terrain({
  ...
  // Initialize CPU sampler for terrain collision clamping in FloatingBody
  useEffect(() => {
    initTerrainSampler(heightmapUrl, heightScale, terrainDepth);
  }, [heightScale, terrainDepth]);
